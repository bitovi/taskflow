...
export async function getFilteredTasks(searchQuery?: string, statuses?: string[], priorities?: string[]) {
    try {
        const whereClause: any = {};
        
        // Add search filter for name and description (SQLite compatible)
