...
export async function getFilteredTasks(searchText?: string, status?: string, priority?: string) {
    try {
        const whereClause: any = {};

        // Add text search filter (SQLite doesn't support mode: "insensitive", so we'll do case-insensitive search manually)
        ...
        console.error("Error in getFilteredTasks:", e);
