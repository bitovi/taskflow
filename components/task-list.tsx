...
export function TaskList({ initialTasks, filteredTasks, hasFilters }: { 
      ...
      {optimisticTasks.length === 0 ? (
        <div className="text-center py-12">
          <div className="text-muted-foreground text-lg">
            {hasFilters ? "No tasks match your search and filter criteria" : "No tasks found"}
          </div>
          <div className="text-muted-foreground text-sm mt-2">
            {hasFilters ? "Try adjusting your search or filter settings" : "Create your first task to get started"}
          </div>
        </div>
      ) : (
